    ...
    <nav className="bg-[#091930] px-2 px-auto py-2.5 rounded flex justify-center">
        <div className="">
            ...
            <div className="w-full md:block md:w-auto" id="navbar-default">
                <ul className="flex justify-center flex-row flex-wrap p-2 mt-2 bg-slate-800 border border-slate-600 rounded-lg md:space-x-8 md:text-md md:px-4 font-medium">
                    <li>
                    ...
                    <li>
                    <a href="#" className="block py-2 pl-3 pr-4 text-white rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-200 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Resume</a>
                    </li>
                    <li>
                    <a href="#" className="block py-2 pl-3 pr-4 text-white rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-200 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Contact</a>
                    </li>
                </ul>
            </div>
        </div>
